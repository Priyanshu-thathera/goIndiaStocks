...
const Sidebar = () => {
  ...
  return (
    <div className={(toggleMenu ? "min-w-80" : " w-6 items-center")}>
      <div className={"sidebar flex h-full fixed text-white"}>
        <div
          className={
        ...
        <div className="arrow flex items-center w-6 bg-slate-400">
          <button
            className="flex items-center text-5xl w-full h-40 bg-sky-900"
            onClick={handleSidebarToggle}
          >
            <i className="ri-arrow-right-s-fill -m-2"></i>
          </button>
        </div>
      </div>
      </div>
